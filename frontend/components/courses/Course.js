...
const Course = (props) => {
  ...
  return (
    <Fragment>
      <Head>
        <title>{`${course.Title} | ${course.SubjectCode}`}</title>
      </Head>

      <CourseNav title={course.Title} courseId={course.id} />
      ...
      <div id="course-container">
        <main>
          ...
          <section>
            ...
            <p>
              Instructor
              {course.Instructors && course.Instructors.length > 1 ? "s" : ""}:
            ...
            <div className="link-grid">
              <div
                onClick={() => router.push(`/courses/${course.id}/syllabus`)}
              >
              ...
              <div
                onClick={() => router.push(`/courses/${course.id}/resources`)}
              >
          ...
          <section>
            ...
            <div className="announcement">
              When things pop up, add them here. Just type `/callout` and press
              `enter` to add one of these handy callout boxes with an emoji and
              color of your choice. Example below.
            </div>
            <div className="announcement">
              **Reading change:** Let's also read Chapter 4 this week in
